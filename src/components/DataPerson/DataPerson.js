...
function DataPerson({ personData }) {
  return (
    <div className="data-person">
      <p>
        Выбран пользователь:{" "}
        <b>{personData.firstName + " " + personData.lastName}</b>
      </p>
      <p>Описание:</p>
      ...
      <p>
        Город: <b>{personData.address.city}</b>
      </p>
      <p>
        Провинция/штат: <b>{personData.address.state}</b>
      </p>
      <p>
        Индекс: <b>{personData.address.zip}</b>
      </p>
    </div>
  );
}
